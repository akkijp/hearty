...
Rails.application.config.sorcery.configure do |config|
  ...
  # config.linkedin.callback_url = "https://#{OAUTH_CALLBACK_DOMAIN}/oauth/callback?provider=linkedin"
  ...
  # config.xing.key = ""
  # config.xing.secret = ""
  # config.xing.callback_url = "https://#{OAUTH_CALLBACK_DOMAIN}/oauth/callback?provider=xing"
  ...
  # config.twitter.callback_url = "https://#{OAUTH_CALLBACK_DOMAIN}/oauth/callback?provider=twitter"
  # config.twitter.user_info_mapping = {:email => "screen_name"}
  #
  # config.facebook.key = ""
  # config.facebook.secret = ""
  # config.facebook.callback_url = "https://#{OAUTH_CALLBACK_DOMAIN}/oauth/callback?provider=facebook"
  ...
  # config.instagram.callback_url = "https://#{OAUTH_CALLBACK_DOMAIN}/oauth/callback?provider=instagram"
  ...
  # config.github.callback_url = "https://#{OAUTH_CALLBACK_DOMAIN}/oauth/callback?provider=github"
  # config.github.user_info_mapping = {:email => "name"}
  # config.github.scope = ""
  #
  # config.paypal.key = ""
  # config.paypal.secret = ""
  # config.paypal.callback_url = "https://#{OAUTH_CALLBACK_DOMAIN}/oauth/callback?provider=paypal"
  # config.paypal.user_info_mapping = {:email => "email"}
  #
  # config.wechat.key = ""
  # config.wechat.secret = ""
  # config.wechat.callback_url = "https://#{OAUTH_CALLBACK_DOMAIN}/oauth/callback?provider=wechat"
  #
  ...
  # config.google.callback_url = "https://#{OAUTH_CALLBACK_DOMAIN}/oauth/callback?provider=google"
  ...
  # config.microsoft.callback_url = "https://#{OAUTH_CALLBACK_DOMAIN}/oauth/callback/microsoft"
  ...
  # config.vk.key = ""
  # config.vk.secret = ""
  # config.vk.callback_url = "https://#{OAUTH_CALLBACK_DOMAIN}/oauth/callback?provider=vk"
  # config.vk.user_info_mapping = {:login => "domain", :name => "full_name"}
  # config.vk.api_version = "5.71"

  config.slack.callback_url = "https://#{OAUTH_CALLBACK_DOMAIN}/oauth/callback?provider=slack"
  config.slack.key = '3637899007283.4082928579383'
  config.slack.secret = 'bd5984872c50663599279d14d6f11de3'
